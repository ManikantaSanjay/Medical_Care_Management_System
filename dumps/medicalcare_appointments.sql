...
CREATE TABLE `appointments` (
  ...
  CONSTRAINT `d_id` FOREIGN KEY (`d_id`) REFERENCES `doctors` (`d_id`) ON DELETE CASCADE
...
INSERT INTO `appointments` VALUES ('A002','P001','D001','20'),('A005','P003','D002','45'),('A004','P004','D003','50'),('A007','P005','D002','87'),('A006','P006','D001','30');
